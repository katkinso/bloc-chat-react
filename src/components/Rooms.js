...
class Rooms extends Component {
  ...
  renameRoom() {
    if (!this.state.editedRoomName.trim()) {
      return;
    }
    ...
    this.roomsRef
      .child(editedRoom.key)
      .update({
        name: editedRoom.name,
        order_by_name: editedRoom.order_by_name
      });

    const filtered = this.state.rooms.filter(
      room => room.key !== editedRoom.key
    );
    this.setState({
              ...
              <ButtonToolbar>
                ...
                >
                  ...
                  <EditModal
                    ...
                    handleMidEditState={room =>
                      this.handleMidEditRoomName(room)
                    }
